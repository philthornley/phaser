//Preloader
var GameStateHolder = GameStateHolder || {};
...
GameStateHolder.Preloader.prototype = {
		...
		preload: function () {
				...
				this.load.image('menu', 'assets/images/screen-mainmenu.png');
				this.load.spritesheet('playButton','assets/images/playButton.png',0,0);
